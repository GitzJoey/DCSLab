...
class SaleOrderProductUnitFactory extends Factory
{
    public function definition(): array
    {
        return [
            ...
            'product_unit_global_discount_rate' => fake()->randomNumber(0, 10000),
            'product_unit_global_discount_fixed' => fake()->randomNumber(0, 10000),
            'product_unit_grand_total' => fake()->randomNumber(0, 10000),
            ...
            'product_final_price_base_unit' => fake()->randomNumber(0, 10000),

            'it_has_sale' => fake()->randomNumber(0, 10000),
            'it_sent' => fake()->randomNumber(0, 10000),
        ];
    }
}
