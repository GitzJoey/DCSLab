...
const cards = ref<Array<TwoColumnsLayoutCards>>([
  {
    title: "views.branch.field_groups.company_info",
    ...
    <TwoColumnsLayout :cards="cards" :using-side-tab="false" @handle-expand-card="handleExpandCard">
        ...
        <div class="p-5">
          ...
          <div class="pb-4">
            ...
            <FormInput
              ...
              :placeholder="t('views.branch.fields.name')"
              @change="branchForm.validate('name')"
            />
          ...
          <div class="pb-4">
            ...
            <FormTextarea v-model="branchForm.remarks" type="text" :placeholder="t('views.branch.fields.remarks')" rows="3" />
          </div>
          <div class="pb-4">
            <FormLabel :class="{ 'text-danger': branchForm.invalid('status') }">
              {{ t("views.branch.fields.status") }}
            </FormLabel>
            <FormSelect v-model="branchForm.status" :class="{ 'border-danger': branchForm.invalid('status') }" @change="branchForm.validate('status')">
              <option value="">
      ...
      <template #card-items-button>
        <div class="flex gap-4">
          <Button type="submit" href="#" variant="primary" class="w-28 shadow-md" :disabled="branchForm.validating || branchForm.hasErrors">
