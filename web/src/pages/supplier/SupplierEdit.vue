...
import { FormInput, FormLabel, FormTextarea, FormSelect, FormSwitch, FormInputCode, FormErrorMessages, FormCheck } from "@/components/Base/Form";
        ...
        <div class="p-5">
          ...
          <div class="mt-3">
            ...
            <FormInputCode
              id="code"
              v-model="form.code"
              :placeholder="t('views.supplier.fields.code')"
              :class="{ 'border-danger': form.invalid('code') }"
              @set-auto="setCode"
          ...
          <div class="mt-3">
            ...
            <FormTextarea
              ...
              :class="{ 'border-danger': form.invalid('address') }"
          ...
          <div class="mt-3">
            ...
            <FormInput
              ...
              :class="{ 'border-danger': form.invalid('city') }"
          ...
          <div class="mt-3">
            ...
            <FormTextarea
              ...
              :class="{ 'border-danger': form.invalid('remarks') }"
        ...
        <div class="p-5">
          ...
          <div class="mt-3">
            ...
            <FormSwitch class="mt-2">
              <FormSwitch.Input
                id="taxable_enterprise"
                v-model="form.taxable_enterprise"
                type="checkbox"
          ...
          <div class="mt-3">
            ...
            <FormInput
              ...
              :class="{ 'border-danger': form.invalid('tax_id') }"
              @change="form.validate('tax_id')"
            />
