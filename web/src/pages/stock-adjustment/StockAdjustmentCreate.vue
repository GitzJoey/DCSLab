<script setup lang="ts">
  ...
  const stockAdjustmentForm =
    stockAdjustmentService.useStockAdjustmentCreateForm();
  ...
  const searchProductUnits = async () => {
    ...
    if (result.success && result.data) {
      ...
      productUnitOptions.value = products.flatMap((p: any) => {
        ...
        const baseUnitName =
          baseUnit && baseUnit.unit ? baseUnit.unit.name : '';
    ...
    >
          ...
          <div class="grid grid-cols-12 gap-4 gap-y-3">
            ...
            <div class="col-span-12 lg:col-span-4">
              ...
              <div class="flex items-center gap-2">
                ...
                <button
                  v-if="stockAdjustmentForm.category_id"
                  type="button"
            ...
            <div class="col-span-12 lg:col-span-6">
              ...
              <div class="flex items-center gap-2">
                ...
                <button
                  v-if="stockAdjustmentForm.in_warehouse_id"
                  type="button"
                  class="text-slate-500 hover:text-danger"
                  @click="clearInWarehouse"
                >
                  <Lucide icon="X" class="w-4 h-4" />
                </button>
              </div>
            ...
            <div class="col-span-12 lg:col-span-6">
              ...
              <div class="flex items-center gap-2">
                ...
                <button
                  v-if="stockAdjustmentForm.out_warehouse_id"
                  type="button"
                  class="text-slate-500 hover:text-danger"
                  @click="clearOutWarehouse"
                >
                  <Lucide icon="X" class="w-4 h-4" />
                </button>
              </div>
      ...
      <template #card-items-2>
        <div class="p-5">
          ...
          <div v-else class="space-y-5">
            <div
              v-for="(item, index) in inProductsForm"
              :key="index"
      ...
      <template #card-items-3>
        <div class="p-5">
          ...
          <div v-else class="space-y-5">
            <div
              v-for="(item, index) in outProductsForm"
              :key="index"
              class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-4"
            >
              <!-- out_product actions -->
          ...
          >
            <table class="min-w-full text-sm">
              ...
              <tbody>
                ...
                <!-- product unit rows -->
                <tr
                  v-for="(opt, idx) in productUnitOptions"
                  :key="idx"
