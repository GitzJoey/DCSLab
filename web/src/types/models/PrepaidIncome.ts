...
import type { PrepaidIncomeImage } from './PrepaidIncomeImage';
import type { PrepaidIncomePayment } from './PrepaidIncomePayment';

export interface PrepaidIncome {
  id: string;
  ulid: string;
  company?: Company;
  branch?: Branch;
  ...
  amount_total: number;
  remarks: string | null;
  prepaid_income_images?: PrepaidIncomeImage[];
  main_prepaid_income_image?: PrepaidIncomeImage | null;
  payments?: PrepaidIncomePayment[];
}
