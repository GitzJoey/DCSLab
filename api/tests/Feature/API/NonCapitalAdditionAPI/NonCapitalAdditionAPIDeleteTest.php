...
class NonCapitalAdditionAPIDeleteTest extends APITestCase
{
    ...
    public function test_non_capital_addition_api_call_delete_without_access_right_expect_unauthorized_message()
    {
        $user = User::factory()
            ->has(Company::factory()->setStatusActive()->setIsDefault())
            ->create();
    ...
    public function test_non_capital_addition_api_call_delete_of_nonexistance_ulid_expect_not_found()
    {
    ...
    public function test_non_capital_addition_api_call_delete_without_parameters_expect_failed()
    {
