...
const loadData = async (ulid: string) => {
  ...
  const result: ServiceResponse<Brand | null> = await brandService.read(ulid);
    ...
    <TwoColumnsLayout :cards="cards" :using-side-tab="false" @handle-expand-card="handleExpandCard">
      ...
      <template #card-items-button>
        <div class="flex gap-4">
          <Button type="submit" href="#" variant="primary" class="w-28 shadow-md" :disabled="brandForm.validating || brandForm.hasErrors">
