...
import { FormInput, FormLabel, FormTextarea, FormSelect, FormSwitch, FormInputCode, FormErrorMessages } from "@/components/Base/Form";
    ...
    <TwoColumnsLayout :cards="cards" :using-side-tab="false" @handle-expand-card="handleExpandCard">
      ...
      <template #card-items-1>
        <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <FormInput v-model="customerGroupForm.max_open_invoice" type="number" @change="customerGroupForm.validate('max_open_invoice')" />
          ...
          <div>
            ...
            <FormInput v-model="customerGroupForm.max_outstanding_invoice" type="number" @change="customerGroupForm.validate('max_outstanding_invoice')" />
          ...
          <div>
            ...
            <FormInput v-model="customerGroupForm.max_invoice_age" type="number" @change="customerGroupForm.validate('max_invoice_age')" />
          ...
          <div>
            ...
            <FormSelect v-model="customerGroupForm.payment_term_type" @change="customerGroupForm.validate('payment_term_type')">
              <option value="">
                {{ t("components.dropdown.placeholder") }}
              </option>
              <option v-for="pt in paymentTermTypeDDL" :key="pt.code" :value="pt.code">
                {{ t(pt.name) }}
              </option>
            </FormSelect>
          ...
          <div class="col-span-1 md:col-span-2">
            ...
            <FormInput v-model="customerGroupForm.payment_term" type="number" @change="customerGroupForm.validate('payment_term')" />
        ...
        <div class="p-5">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <FormInput v-model="customerGroupForm.price_markup_percent" type="number" @change="customerGroupForm.validate('price_markup_percent')" />
            ...
            <div>
              ...
              <FormInput v-model="customerGroupForm.price_markup_nominal" type="number" @change="customerGroupForm.validate('price_markup_nominal')" />
            ...
            <div>
              ...
              <FormInput v-model="customerGroupForm.price_markdown_percent" type="number" @change="customerGroupForm.validate('price_markdown_percent')" />
            ...
            <div>
              ...
              <FormInput v-model="customerGroupForm.price_markdown_nominal" type="number" @change="customerGroupForm.validate('price_markdown_nominal')" />
        ...
        <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <FormSelect v-model="customerGroupForm.rounding_type" @change="customerGroupForm.validate('rounding_type')">
              ...
              <option v-for="ro in roundOnDDL" :key="ro.code" :value="ro.code">
                {{ t(ro.name) }}
              </option>
            </FormSelect>
      ...
      <template #card-items-button>
        <div class="flex gap-4">
          <Button type="submit" href="#" variant="primary" class="w-28 shadow-md" :disabled="customerGroupForm.validating || customerGroupForm.hasErrors">
