...
class ChartOfAccountPolicy
{
    ...
    public function viewAny(User $user)
    {
        ...
        if ($user->hasPermission('chart_of_account-readAny')) {
            return true;
        }
    }
    ...
    public function view(User $user, ?ChartOfAccount $chartOfAccount = null)
    {
        ...
        if ($user->hasPermission('chart_of_account-read')) {
            return true;
        }
    }
    ...
    public function create(User $user)
    {
        ...
        if ($user->hasPermission('chart_of_account-create')) {
            return true;
        }
    }
    ...
    public function update(User $user, ?ChartOfAccount $chartOfAccount = null)
    {
        ...
        if ($user->hasPermission('chart_of_account-update')) {
            return true;
        }
    }
    ...
    public function delete(User $user, ?ChartOfAccount $chartOfAccount = null)
    {
        ...
        if ($user->hasPermission('chart_of_account-delete')) {
            return true;
        }
    }
