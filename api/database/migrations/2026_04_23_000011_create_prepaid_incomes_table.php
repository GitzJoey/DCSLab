...
return new class extends Migration
{
    ...
    {
        Schema::create('prepaid_incomes', function (Blueprint $table) {
            $table->id();
            $table->ulid();
            ...
            $table->foreign('paid_immediately_cash_account_id', 'pins_pica_id_fk')->references('id')->on('cash_accounts');
    ...
    {
        Schema::dropIfExists('prepaid_incomes');
    }
};
