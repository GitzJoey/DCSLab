...
<template>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="col-span-12 intro-y lg:col-span-12">
            <!-- data list wrapper -->
            <DataList :title="t('views.stock_adjustment.table.title')" :data="stockAdjustmentLists"
                :enable-search="true" :can-print="true" :can-export="true"
                                ...
                                <Table.Tr class="intro-x">
                                    ...
                                    <Table.Td>
                                        <div class="flex items-center">
                                            <Lucide v-if="item.is_posted" icon="CheckCircle"
                                            ...
                                            <div class="col-span-12">
                                                ...
                                                <div class="grid grid-cols-1 gap-y-2">
                                                    ...
                                                    <div class="mt-4">
                                                        ...
                                                        <div v-if="item.in_products.length === 0"
                                                            class="text-slate-500 text-sm">
                                                            {{ t("components.data-list.data_not_found") }}
                                                        </div>
                                                        <div v-else class="space-y-2 text-xs sm:text-sm">
                                                            <div v-for="(p, index) in item.in_products" :key="p.ulid"
                                                                class="flex gap-3">
                                                    ...
                                                    <div class="mt-4">
                                                        ...
                                                        <div v-if="item.out_products.length === 0"
                                                            class="text-slate-500 text-sm">
                                                            {{ t("components.data-list.data_not_found") }}
                                                        </div>
                                                        <div v-else class="space-y-2 text-xs sm:text-sm">
                                                            <div v-for="(p, index) in item.out_products" :key="p.ulid"
                                                                class="flex gap-3">
                                                                <div class="w-6 text-right text-slate-500">
                                                                    {{ index + 1 }}.
                                                                </div>
