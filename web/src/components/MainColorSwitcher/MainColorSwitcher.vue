...
<template>
  <div v-if="visible"
    ...
    <a @click="switchColorScheme('default')" :class="[
    ...
    <a @click="switchColorScheme('theme-1')" :class="[
    ...
    <a @click="switchColorScheme('theme-2')" :class="[
    ...
    <a @click="switchColorScheme('theme-3')" :class="[
    ...
    <a @click="switchColorScheme('theme-4')" :class="[
