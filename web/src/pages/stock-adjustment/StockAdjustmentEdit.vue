...
import { FormInput, FormLabel, FormErrorMessages, FormInputCode, FormInputCurrency, FormTextarea, FormSelectSearch, FormSwitch } from "@/components/Base/Form";
...
const inProductsForm = computed<StockAdjustmentInProductFormItem[]>(() => stockAdjustmentForm.in_products as StockAdjustmentInProductFormItem[]);
const outProductsForm = computed<StockAdjustmentOutProductFormItem[]>(() => stockAdjustmentForm.out_products as StockAdjustmentOutProductFormItem[]);
// #endregion
  ...
  if (result.success && result.data) {
    ...
    if (inProducts.length > 0) {
      cards.value = cards.value.map((card) =>
        card.title === "views.stock_adjustment.field_groups.in_products" ? { ...card, state: CardState.Expanded } : card,
      );
    }

    if (outProducts.length > 0) {
      cards.value = cards.value.map((card) =>
        card.title === "views.stock_adjustment.field_groups.out_products" ? { ...card, state: CardState.Expanded } : card,
      );
    }
  }
};
...
const toggleOutProductRemarks = (index: number) => {
  ...
  outProductsRemarksExpanded.value = [...outProductsRemarksExpanded.value.slice(0, index), !current, ...outProductsRemarksExpanded.value.slice(index + 1)];
};
    ...
    <TwoColumnsLayout :cards="cards" :using-side-tab="false" @handle-expand-card="handleExpandCard">
          ...
          <div class="grid grid-cols-12 gap-4 gap-y-3">
            <div class="col-span-12 lg:col-span-4 md:col-span-6">
              ...
              <FormInputCode
                ...
                :placeholder="t('views.stock_adjustment.fields.code')"
                @set-auto="setCode"
            ...
            <div class="col-span-12 lg:col-span-4">
              ...
              <div class="flex items-center gap-2">
                ...
                <button v-if="stockAdjustmentForm.category_id" type="button" class="text-slate-500 hover:text-danger" @click="clearCategory">
            ...
            <div class="col-span-12 lg:col-span-6">
              ...
              <div class="flex items-center gap-2">
                <div class="flex-1">
                  <FormSelectSearch
                    v-model="stockAdjustmentForm.in_warehouse_id"
                    v-model:search="inWarehouseSearch"
                ...
                <button v-if="stockAdjustmentForm.in_warehouse_id" type="button" class="text-slate-500 hover:text-danger" @click="clearInWarehouse">
                  <Lucide icon="X" class="w-4 h-4" />
                </button>
              </div>
            ...
            <div class="col-span-12 lg:col-span-6">
              ...
              <div class="flex items-center gap-2">
                <div class="flex-1">
                  <FormSelectSearch
                    v-model="stockAdjustmentForm.out_warehouse_id"
                    v-model:search="outWarehouseSearch"
                ...
                <button v-if="stockAdjustmentForm.out_warehouse_id" type="button" class="text-slate-500 hover:text-danger" @click="clearOutWarehouse">
                  <Lucide icon="X" class="w-4 h-4" />
                </button>
              </div>
      ...
      <template #card-items-2>
        <div class="p-5">
          ...
          <div v-else class="space-y-5">
            <div v-for="(item, index) in inProductsForm" :key="index" class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-4">
              <!-- in_product actions -->
              <div class="flex items-center justify-between mb-3">
                <div class="font-medium text-sm">{{ t("views.stock_adjustment_in_product.page_title") }} #{{ index + 1 }}</div>
                <div class="flex items-center gap-2">
                  <Button type="button" class="text-xs text-slate-500 hover:text-primary" @click="toggleInProductRemarks(index)">
              ...
              <div class="grid grid-cols-12 gap-4 gap-y-3">
                ...
                <div class="col-span-12 lg:col-span-5">
                  ...
                  <FormErrorMessages :messages="(stockAdjustmentForm.errors as any)[`in_products.${index}.product_unit_id`]" />
                ...
                <div class="col-span-12 lg:col-span-1">
                  <FormLabel
                    :class="{
                      'text-danger': stockAdjustmentForm.invalid(`in_products.${index}.product_unit_conversion_value` as any),
                    }"
                  >
                ...
                <div class="col-span-12 lg:col-span-2">
                  ...
                  />
                  <FormErrorMessages :messages="(stockAdjustmentForm.errors as any)[`in_products.${index}.product_unit_cogs`]" />
                  <div
                    v-if="item.product_unit_conversion_value > 1 && item.product_unit_cogs && item.product_unit_base_unit_name"
                ...
                <div class="col-span-12 lg:col-span-2">
                  ...
                  <FormInputCurrency :model-value="item.product_unit_total_cogs ?? 0" readonly tabindex="-1" class="text-right" />
                </div>
      ...
      <template #card-items-3>
        <div class="p-5">
          ...
          <!-- out_product list -->
          <div v-else class="space-y-5">
            <div v-for="(item, index) in outProductsForm" :key="index" class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-4">
              <div class="flex items-center justify-between mb-3">
                <div class="font-medium text-sm">{{ t("views.stock_adjustment_out_product.page_title") }} #{{ index + 1 }}</div>
                <div class="flex items-center gap-2">
                  <Button type="button" class="text-xs text-slate-500 hover:text-primary" @click="toggleOutProductRemarks(index)">
              ...
              <div class="grid grid-cols-12 gap-4 gap-y-3">
                ...
                <div class="col-span-12 lg:col-span-5">
                  ...
                  <FormErrorMessages :messages="(stockAdjustmentForm.errors as any)[`out_products.${index}.product_unit_id`]" />
                  <div class="text-sm text-slate-500 font-bold mt-1">
                    {{ item.product_unit_product_code }}
                  </div>
                </div>
                ...
                <div class="col-span-12 lg:col-span-3">
                  <FormLabel
                    :class="{
                      'text-danger': stockAdjustmentForm.invalid(`out_products.${index}.product_unit_conversion_value` as any),
                    }"
                  >
                  ...
                  <FormInputCurrency
                    ...
                    :class="[
                      'text-right',
                      {
                        'border-danger': stockAdjustmentForm.invalid(`out_products.${index}.product_unit_conversion_value` as any),
                      },
                    ]"
                  />
      ...
      <template #card-items-button>
        <div class="flex gap-4 p-5">
          <Button type="submit" href="#" variant="primary" class="w-28 shadow-md" :disabled="stockAdjustmentForm.validating || stockAdjustmentForm.hasErrors">
      ...
      <Dialog.Panel>
        <div class="p-5">
          ...
          <div class="flex items-center gap-2 mb-4">
            ...
            />
            <Button type="button" variant="primary" class="shadow-md" @click="searchProductUnits" tabindex="-1" :disabled="isSearchingProductUnit">
          ...
          <div class="max-h-80 overflow-auto border border-slate-200/60 dark:border-darkmode-400 rounded-md">
            <table class="min-w-full text-sm">
              ...
              <tbody>
                ...
                <!-- product unit rows -->
                <tr v-for="(opt, idx) in productUnitOptions" :key="idx" class="border-t border-slate-200/60 dark:border-darkmode-400">
                  <!-- product -->
