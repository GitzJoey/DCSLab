                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-5 bg-white bg-opacity-50 rounded border-1">
                        <form id="registerForm" class="px-3 py-3" action="{{ route('register') }}" method="post">
                            ...
                            <div class="mb-3">
                                <div class="col-12">
                                    <img class="img px-1" src="{{ captcha_src('flat') }}" alt="" /><a href="{{ route('register') }}"><button class="btn bg-white"><i class="icon icon-refresh" aria-hidden="true"></i></button></a>
                            ...
                            <div class="d-flex justify-content-end">
                                <a class="mx-2" href="#" data-bs-toggle="modal" data-bs-target="#modal-terms">
                                    <i class="icon icon-book-open" aria-hidden="true"></i> {{ __('auth.buttons.read_term') }}
                                </a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                    <i class="icon icon-check" aria-hidden="true"></i> {{ __('auth.buttons.accept') }}
                </button>
            </div>
        </div>
    </div>
