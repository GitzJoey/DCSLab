...
<template>
  <div class="grid grid-cols-12 gap-6 mt-5">
    <div class="col-span-12 intro-y lg:col-span-12">
      ...
      <DataList
        :title="t('views.stock_adjustment_in_product_serial.table.title')"
          ...
          <Table class="mt-5" :hover="true">
            <Table.Thead variant="light">
              <Table.Tr>
                ...
                <Table.Th class="whitespace-nowrap">
                  {{ t('views.stock_adjustment_in_product_serial.table.cols.stock_adjustment_code') }}
                </Table.Th>
                <Table.Th class="whitespace-nowrap">
                  {{ t('views.stock_adjustment_in_product_serial.table.cols.product_name') }}
                </Table.Th>
                <Table.Th class="whitespace-nowrap">
                  {{ t('views.stock_adjustment_in_product_serial.table.cols.serial') }}
                </Table.Th>
                <Table.Th class="whitespace-nowrap"></Table.Th>
              </Table.Tr>
            </Table.Thead>
            <Table.Tbody v-if="stockAdjustmentInProductSerialLists !== null">
              <template v-if="stockAdjustmentInProductSerialLists.data.length === 0">
              ...
              <template v-for="(item, itemIdx) in stockAdjustmentInProductSerialLists.data" :key="item.ulid">
                <Table.Tr class="intro-x">
                  <Table.Td>
                  ...
                  <Table.Td>
                    <div class="whitespace-nowrap">
                      {{ item.stock_adjustment_in_product?.product_unit?.product?.name ?? '-' }}
                    </div>
                    <div class="text-slate-500 text-xs whitespace-nowrap">
                      [{{ item.stock_adjustment_in_product?.product_unit?.code ?? '-' }}]
                    </div>
                  </Table.Td>
                  <Table.Td>
                    <div class="whitespace-nowrap">
