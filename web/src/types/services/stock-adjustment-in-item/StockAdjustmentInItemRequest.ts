export interface StockAdjustmentInItemReadAnyPaginateRequest {
...
export interface StockAdjustmentInItemReadAnyGetRequest {
  with_trashed: boolean;
  company_id: string;
  branch_id?: string | null;
  search?: string | null;
...
export interface StockAdjustmentInItemStoreRequest {
  company_id: string;
  branch_id: string;
...
export interface StockAdjustmentInItemUpdateRequest {
  company_id: string;
  branch_id: string;
  stock_adjustment_id: string;
  qty: number;
