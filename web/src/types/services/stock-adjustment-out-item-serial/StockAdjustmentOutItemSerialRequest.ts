export interface StockAdjustmentOutItemSerialReadAnyPaginateRequest {
...
export interface StockAdjustmentOutItemSerialReadAnyGetRequest {
  with_trashed: boolean;
  company_id: string;
  branch_id?: string | null;
  search?: string | null;
...
export interface StockAdjustmentOutItemSerialStoreRequest {
  company_id: string;
  branch_id: string;
  stock_adjustment_id: string;
  stock_adjustment_out_item_id: string;
  serial: string;
}

export interface StockAdjustmentOutItemSerialUpdateRequest {
  serial: string;
}
