...
use App\Http\Requests\StockAdjustmentOutItemSerial\StockAdjustmentOutItemSerialStoreRequest;
use App\Http\Requests\StockAdjustmentOutItemSerial\StockAdjustmentOutItemSerialUpdateRequest;
use App\Http\Resources\StockAdjustmentOutItemSerialResource;
...
class StockAdjustmentOutItemSerialController extends BaseController
{
    private $stockAdjustmentOutItemSerialActions;

    public function __construct(StockAdjustmentOutItemSerialActions $stockAdjustmentOutItemSerialActions)
    {
        parent::__construct();
    ...
    public function readAny(Request $request)
    {
        ...
        $this->authorize('viewAny', StockAdjustmentOutItemSerial::class);
        ...
        try {
            $result = $this->stockAdjustmentOutItemSerialActions->readAny(
        ...
        return StockAdjustmentOutItemSerialResource::collection($result);
    }

    public function read(StockAdjustmentOutItemSerial $stockAdjustmentOutItemSerial)
    {
        if (! Auth::check()) return response()->error(trans('auth.unauthenticated'), 401);

        $this->authorize('view', $stockAdjustmentOutItemSerial);

        $result = null;
        $errorMsg = '';

        try {
            $result = $this->stockAdjustmentOutItemSerialActions->read($stockAdjustmentOutItemSerial);
        } catch (Exception $e) {
            $errorMsg = app()->environment('production') ? '' : $e->getMessage();
        }
        ...
        return new StockAdjustmentOutItemSerialResource($result);
    }

    public function store(StockAdjustmentOutItemSerialStoreRequest $request)
    {
        ...
        try {
            ...
            $data = new StockAdjustmentOutItemSerialCreateDTO(
                ...
                stockAdjustmentOutItemId: $validated['stock_adjustment_out_item_id'],
    ...
    public function update(StockAdjustmentOutItemSerial $stockAdjustmentOutItemSerial, StockAdjustmentOutItemSerialUpdateRequest $request)
    {
        $validated = $request->validated();
        ...
        try {
            ...
            $data = StockAdjustmentOutItemSerialUpdateDTO::fromStockAdjustmentOutItemSerial(
                $stockAdjustmentOutItemSerial,
                $validated['serial']
            );

            $result = $this->stockAdjustmentOutItemSerialActions->update(
                $stockAdjustmentOutItemSerial,
                $data
            );
    ...
    public function delete(StockAdjustmentOutItemSerial $stockAdjustmentOutItemSerial)
    {
        if (! Auth::check()) return response()->error(trans('auth.unauthenticated'), 401);

        $this->authorize('delete', $stockAdjustmentOutItemSerial);
        ...
        try {
            ...
            $result = $this->stockAdjustmentOutItemSerialActions->delete($stockAdjustmentOutItemSerial);
