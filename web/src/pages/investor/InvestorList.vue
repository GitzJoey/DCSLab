...
<template>
  <DataList
    :title="t('views.investor.table.title')"
    :enable-search="true"
    :can-print="true"
    :can-export="true"
    :pagination="investorLists ? investorLists.meta : null"
  ...
  >
    <template #content>
      <Table class="mt-5" :hover="true">
        ...
        <Table.Tbody v-if="investorLists !== null">
          <template v-if="investorLists.data.length == 0">
