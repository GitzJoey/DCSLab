    ...
    <div @mouseenter="onMouseEnterSideMenu" @mouseleave="onMouseLeaveSideMenu" :class="[
      ...
      <div :class="[
        ...
        <div
          ...
          <a class="flex items-center transition-[margin] duration-100 xl:ml-2 group-[.side-menu--collapsed.side-menu--on-hover]:xl:ml-2 group-[.side-menu--collapsed]:xl:ml-6"
            href="">
