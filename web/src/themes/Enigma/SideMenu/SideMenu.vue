...
<template>
  <div :class="[
    ...
    <div @mouseenter="onMouseEnterSideMenu" @mouseleave="onMouseLeaveSideMenu" :class="[
      ...
      <div @click="closeMobileMenu" :class="[
        'close-mobile-menu fixed ml-80 xl:hidden z-50 cursor-pointer text-background dark:text-foreground hidden',
      ...
      <div :class="[
        'side-menu__content',
        'z-20 relative w-[320px] duration-100 transition-[width] group-[.side-menu--collapsed]:xl:w-41.25 group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[320px] h-screen flex flex-col-reverse xl:flex-col',
        ...
        <div
          class="relative z-10 mt-3 hidden h-22.5 w-[320px] flex-none items-center overflow-hidden pl-8 pr-14 duration-100 xl:flex group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[320px] group-[.side-menu--collapsed]:xl:w-41.25">
          <a class="relative flex items-center transition-[margin] duration-100 xl:ml-1.5 group-[.side-menu--collapsed.side-menu--on-hover]:xl:ml-1.5 group-[.side-menu--collapsed]:xl:ml-8"
            href="">
          ...
          <a @click="toggleCompactMenu"
            class="toggle-compact-menu text-background dark:text-foreground border-background/20 bg-background/10 dark:bg-foreground/2 dark:border-foreground/11 relative ml-auto hidden items-center justify-center rounded-md border py-0.5 pl-0.5 pr-1 opacity-70 transition-[opacity,transform] hover:opacity-100 group-[.side-menu--collapsed]:xl:rotate-180 group-[.side-menu--collapsed.side-menu--on-hover]:xl:opacity-100 group-[.side-menu--collapsed]:xl:opacity-0 2xl:flex"
            href="">
    ...
    <div :class="[
      ...
      <div :class="[
        ...
        <div class="h-full overflow-x-hidden">
          <div @scroll="onScrollContent" :class="[
            ...
            { '-ml-38.75': compactMenu && compactMenuOnHover && !mobileMenuOpen },
          ]">
            <div :class="[
              'top-bar group fixed inset-x-0 mt-3 top-0 z-50 pl-9 xl:pl-6 pr-9 xl:pr-5 transition-[margin,width] duration-100 xl:ml-80 xl:mr-5 group-[.content--compact]:xl:ml-41.25',
              'before:inset-y-0 before:left-4 before:transition-[margin] before:duration-100 before:right-0 before:absolute xl:before:-ml-80 group-[.content--compact]:xl:before:-ml-41.25 before:bg-primary before:border before:border-primary dark:before:border-[color-mix(in_oklch,var(--color-background),white_27%)] dark:before:bg-[color-mix(in_oklch,var(--color-background),white_14%)] before:my-3 before:rounded-2xl before:mr-4 xl:before:-mr-1',
              'after:inset-0 after:left-8 after:transition-[margin] after:duration-100 after:right-0 after:absolute xl:after:-ml-80 group-[.content--compact]:xl:after:-ml-41.25 after:bg-primary/30 after:border after:border-primary/10 dark:after:border-[color-mix(in_oklch,var(--color-background),white_27%)] dark:after:bg-[color-mix(in_oklch,var(--color-background),white_14%)] after:z-[-1] after:mb-3 after:rounded-2xl after:mr-8 xl:after:mr-4',
              { scrolled: scrolled },
            ]">
              <div :class="['relative z-20 flex h-22.5 items-center gap-5']">
