...
class SaleOrderDownPaymentApplyAPICreateTest extends APITestCase
{
    ...
    public function test_sale_order_down_payment_apply_api_call_store_without_access_right_expect_unauthorized_message()
    {
        $user = User::factory()
            ->has(Company::factory()->setStatusActive()->setIsDefault())
            ->create();
    ...
    public function test_sale_order_down_payment_apply_api_call_store_with_script_tags_in_payload_expect_stripped()
    {
        $this->markTestIncomplete('Not implemented yet.');
    }

    public function test_sale_order_down_payment_apply_api_call_store_with_script_tags_in_payload_expect_encoded()
    {
    ...
    public function test_sale_order_down_payment_apply_api_call_store_with_nonexistance_branch_id_expect_failed()
    {
        $this->markTestIncomplete('Not implemented yet.');
    }
