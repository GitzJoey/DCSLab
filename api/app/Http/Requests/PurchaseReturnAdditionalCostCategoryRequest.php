...
class PurchaseReturnAdditionalCostCategoryRequest extends FormRequest
{
    public function authorize()
    {
        ...
        switch ($currentRouteMethod) {
            case 'readAny':
                return $user->can('viewAny', PurchaseReturnAdditionalCostCategory::class) ? true : false;
            case 'read':
                return $user->can('view', PurchaseReturnAdditionalCostCategory::class, $purchaseReturnAdditionalCostCategory) ? true : false;
            case 'store':
                return $user->can('create', PurchaseReturnAdditionalCostCategory::class) ? true : false;
            case 'update':
                return $user->can('update', PurchaseReturnAdditionalCostCategory::class, $purchaseReturnAdditionalCostCategory) ? true : false;
            case 'delete':
                return $user->can('delete', PurchaseReturnAdditionalCostCategory::class, $purchaseReturnAdditionalCostCategory) ? true : false;
            default:
                return false;
        }
    }
