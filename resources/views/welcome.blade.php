...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ mix('css/start/magnific-popup.css') }}">
        <link rel="stylesheet" href="{{ mix('css/start/default.css') }}">
        <link rel="stylesheet" href="{{ mix('css/start/style.css') }}">
    </head>
