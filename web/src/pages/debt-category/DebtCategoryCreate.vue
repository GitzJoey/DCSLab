...
const debtCategoryForm = debtCategoryService.useDebtCategoryCreateForm();
// #endregion
...
watch(
  ...
  debounce((newValue): void => {
    cacheService.setLastEntity('DEBT_CATEGORY_CREATE', newValue.data());
  }, 500),
  { deep: true },
);
// #endregion
...
const loadFromCache = () => {
  const data = cacheService.getLastEntity('DEBT_CATEGORY_CREATE') as Record<string, unknown> | null;
  if (!data) return;
