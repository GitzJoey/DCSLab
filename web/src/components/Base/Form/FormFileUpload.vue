...
<template>
  <div v-if="imageUrl" :class="['flex', 'justify-center', 'mt-2', 'w-full', 'align-center', { 'bg-slate-100': imageUrl }, 'rounded', 'p-4']">
  ...
  <div class="flex gap-2 mt-4">
    ...
    <label class="border-slate-200 border w-[15%] rounded bg-slate-100 cursor-pointer flex justify-center items-center" for="upload">
      {{ t("components.file-upload.browse") }}
    </label>
  </div>
</template>
