...
mix
    ...
    .js('resources/js/apps/investor.js','public/js/apps/investor.js')
    .js('resources/js/apps/capitalgroup.js','public/js/apps/capitalgroup.js')
    .js('resources/js/apps/capital.js','public/js/apps/capital.js')
    .js('resources/js/apps/incomegroup.js','public/js/apps/incomegroup.js')
