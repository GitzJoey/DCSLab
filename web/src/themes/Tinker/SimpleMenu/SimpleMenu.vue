...
import { type ProvideForceActiveMenu, forceActiveMenu, type Route, type FormattedMenu, nestedMenu, linkTo, enter, leave } from "./simple-menu";
    ...
    <LoadingOverlay :visible="screenMask" :transparent="false">
      ...
      >
        ...
        <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
          <nav class="side-nav side-nav--simple hidden md:block md:w-[100px] xl:w-[100px] px-5 pb-16 overflow-x-hidden z-10">
            <RouterLink :to="{ name: 'side-menu-dashboard-maindashboard' }" class="flex items-center pt-4 pl-5 mt-3 intro-x">
