...
const computedClass = computed(() =>
  twMerge([
    ...
    group?.value.variant == "boxed" && "p-4 first:mt-0 last:mb-0 border border-slate-200/60 mt-3 dark:border-darkmode-400",
...
<template>
  <HeadlessDisclosure as="div" :defaultOpen="group?.selectedIndex === index" :class="computedClass" v-bind="_.omit(attrs, 'class')" v-slot="{ open, close }">
