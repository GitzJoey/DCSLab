  ...
  <div :class="[
    ...
    <div @mouseenter="onMouseEnterSideMenu" @mouseleave="onMouseLeaveSideMenu" :class="[
      ...
      <div @click="closeMobileMenu" :class="[
        'close-mobile-menu fixed ml-75 xl:hidden z-50 cursor-pointer hidden',
      ...
      <div :class="[
        'side-menu__content',
        'z-20 relative w-75 duration-100 transition-[width] group-[.side-menu--collapsed]:xl:w-37.5 group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-75 h-screen flex flex-col-reverse xl:flex-col',
        ...
        <div
          class="relative z-10 hidden h-17.5 w-75 flex-none items-center overflow-hidden pl-5 pr-14 duration-100 xl:flex group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-75 group-[.side-menu--collapsed]:xl:w-37.5">
          <a class="flex items-center transition-[margin] duration-100 xl:ml-1 group-[.side-menu--collapsed.side-menu--on-hover]:xl:ml-1 group-[.side-menu--collapsed]:xl:ml-7"
            href="">
    ...
    <div :class="[
      ...
      'after:absolute after:bottom-4 after:top-22 after:-ml-px after:right-4 after:left-4 xl:after:left-0 after:bg-[color-mix(in_oklch,var(--color-background),var(--color-foreground)_2%)] after:rounded-4xl after:border after:border-foreground/15 dark:after:bg-[color-mix(in_oklch,var(--color-background),var(--color-foreground)_10%)]',
      'xl:ml-75',
      '[&.content--compact]:xl:ml-37.5',
      ...
      <div :class="[
        ...
        <div class="h-full overflow-x-hidden">
          <div @scroll="onScrollContent" :class="[
            ...
            { '-ml-37.5': compactMenu && compactMenuOnHover && !mobileMenuOpen },
          ]">
            <div :class="[
              'group fixed inset-x-0 top-0 z-20 px-6 transition-[margin,width] duration-100 xl:ml-75 xl:mr-5 group-[.content--compact]:xl:ml-37.5',
              { scrolled: scrolled },
            ]">
              <div :class="['flex h-17.5 items-center gap-5']">
                ...
                <div class="group/profile relative size-9 flex-none">
                  <AvatarRoot class="rounded-full ring-(--color)/40 size-full [--color:var(--color-nav-foreground)]">
