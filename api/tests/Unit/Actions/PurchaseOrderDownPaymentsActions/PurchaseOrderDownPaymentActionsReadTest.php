...
class PurchaseOrderDownPaymentActionsReadTest extends ActionsTestCase
{
    ...
    public function test_purchase_order_down_payments_actions_call_read_any_with_paginate_false_expect_collection_object()
    {
        $user = User::factory()
            ->has(Company::factory()->setStatusActive()->setIsDefault()
                ->has(PurchaseOrderDownPayment::factory())
    ...
    public function test_purchase_order_down_payments_actions_call_read_any_with_nonexistance_companyId_expect_empty_collection()
    {
    ...
    public function test_purchase_order_down_payments_actions_call_read_any_with_page_parameter_negative_expect_results()
    {
        $this->markTestIncomplete('Need to implement test');
    }

    public function test_purchase_order_down_payments_actions_call_read_any_with_perpage_parameter_negative_expect_results()
    {
        $this->markTestIncomplete('Need to implement test');
    }

    public function test_purchase_order_down_payments_actions_call_read_expect_object()
    {
        $user = User::factory()
            ->has(Company::factory()->setStatusActive()->setIsDefault()
                ->has(PurchaseOrderDownPayment::factory())
