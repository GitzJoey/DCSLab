...
import {
  StockAdjustmentCategoryReadAnyPaginateRequest,
  StockAdjustmentCategoryReadAnyGetRequest,
} from "../types/services/stock-adjustment-category/StockAdjustmentCategoryRequest";
...
export default class StockAdjustmentCategoryService {
  ...
  > {
    ...
    try {
      ...
      const url = route(
        "api.get.stock_adjustment_category.read_any",
        {
          _query: queryParams,
        },
        false,
  ...
  public async read(
    ...
    try {
      const url = route(
        "api.get.stock_adjustment_category.read",
        {
  ...
  public useStockAdjustmentCategoryEditForm(ulid: string) {
    const url = route(
      "api.post.stock_adjustment_category.edit",
      {
        stock_adjustment_category: ulid,
      },
      true,
  ...
  public async delete(ulid: string): Promise<ServiceResponse<boolean | null>> {
    ...
    try {
      const url = route(
        "api.post.stock_adjustment_category.delete",
        {
          stock_adjustment_category: ulid,
        },
        false,
