...
class PurchaseOrderDownPaymentPolicy
{
    ...
    public function viewAny(User $user)
    {
        ...
        if ($user->hasPermission('purchase_order_down_payment-readAny')) {
            return true;
        }
    }
    ...
    public function view(User $user, ?PurchaseOrderDownPayment $purchaseOrderDownPayment = null)
    {
        ...
        if ($user->hasPermission('purchase_order_down_payment-read')) {
            return true;
        }
    }
    ...
    public function create(User $user)
    {
        ...
        if ($user->hasPermission('purchase_order_down_payment-create')) {
            return true;
        }
    }
    ...
    public function update(User $user, ?PurchaseOrderDownPayment $purchaseOrderDownPayment = null)
    {
        ...
        if ($user->hasPermission('purchase_order_down_payment-update')) {
            return true;
        }
    }
    ...
    public function delete(User $user, ?PurchaseOrderDownPayment $purchaseOrderDownPayment = null)
    {
        ...
        if ($user->hasPermission('purchase_order_down_payment-delete')) {
            return true;
        }
    }
