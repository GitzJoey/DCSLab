    ...
    <TwoColumnsLayout :cards="cards" :using-side-tab="false" @handle-expand-card="handleExpandCard">
      ...
      <template #card-items-2>
        <div class="p-5 space-y-4">
          ...
          >
            <div
              class="hidden lg:grid grid-cols-[minmax(0,1fr)_6rem_4.5rem_4rem_5.5rem] items-center gap-3 border-b border-slate-200 bg-slate-50/70 px-3 py-2 text-[11px] font-semibold uppercase tracking-wider text-slate-400 dark:border-darkmode-400 dark:bg-darkmode-600/30 dark:text-slate-500"
            >
