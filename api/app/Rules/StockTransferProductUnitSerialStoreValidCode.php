...
class StockTransferProductUnitSerialStoreValidCode implements ValidationRule
{
    protected $companyId;
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        if ($value !== config('dcslab.KEYWORDS.AUTO')) {
            ...
            if (! $stockTransferProductUnitSerialActions->isUniqueCode($this->companyId, $value, null)) {
