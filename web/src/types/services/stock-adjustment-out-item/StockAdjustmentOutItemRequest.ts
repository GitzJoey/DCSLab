export interface StockAdjustmentOutItemReadAnyPaginateRequest {
...
export interface StockAdjustmentOutItemReadAnyGetRequest {
  with_trashed: boolean;
  company_id: string;
  branch_id?: string | null;
  search?: string | null;
...
export interface StockAdjustmentOutItemStoreRequest {
  company_id: string;
  branch_id: string;
...
export interface StockAdjustmentOutItemUpdateRequest {
  company_id: string;
  branch_id: string;
  stock_adjustment_id: string;
  qty: number;
