  ...
  >
    ...
    <div class="p-4">
      ...
      <FormSelect
        ...
        :disabled="selectedSupplier ? true : false"
      >
        <option :value="t('components.dropdown.values.paymentTermTypeDDL.pia')">
          {{ t("components.dropdown.values.paymentTermTypeDDL.pia") }}
        </option>
        <option :value="t('components.dropdown.values.paymentTermTypeDDL.net')">
          {{ t("components.dropdown.values.paymentTermTypeDDL.net") }}
        </option>
        <option :value="t('components.dropdown.values.paymentTermTypeDDL.eom')">
          {{ t("components.dropdown.values.paymentTermTypeDDL.eom") }}
        </option>
        <option :value="t('components.dropdown.values.paymentTermTypeDDL.cod')">
          {{ t("components.dropdown.values.paymentTermTypeDDL.cod") }}
        </option>
        <option :value="t('components.dropdown.values.paymentTermTypeDDL.cnd')">
          {{ t("components.dropdown.values.paymentTermTypeDDL.cnd") }}
        </option>
        <option :value="t('components.dropdown.values.paymentTermTypeDDL.cbs')">
