          ...
          <template #card-items-1>
            <div class="p-5">
              ...
              <div class="flex gap-4">
                <Button variant="primary" class="w-28 shadow-md" @click="handleUpdateAccountSettings">
          ...
          <template #card-items-2>
            <div class="p-5">
              <div class="pb-4">
                ...
                <FormInput id="currentPassword" name="currentPassword" type="password" class="w-full" :placeholder="t('views.profile.fields.change_password.current_password')
                    " />
              </div>
              ...
              <div class="pb-4">
                ...
                <FormInput id="new_password" name="new_password" type="password" class="w-full" :placeholder="t('views.profile.fields.change_password.new_password')
                  " />
              </div>
              ...
              <div class="pb-4">
                ...
                <FormInput id="confirm_password" name="confirm_password" type="password" class="w-full" :placeholder="t('views.profile.fields.change_password.confirm_password')
                    " />
              </div>
            </div>
          </template>
          ...
          <template #card-items-3>
            <div class="p-5">
              <div class="pb-4">
                ...
                <FormSelect id="themes" name="themes">
              ...
              <div class="pb-4">
                ...
                <FormSelect id="date_format" name="date_format">
