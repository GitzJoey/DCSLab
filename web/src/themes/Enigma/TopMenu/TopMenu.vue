...
import '@/assets/css/themes/enigma/top-menu.css'
...
<template>
  <div :class="[
    'enigma min-h-screen bg-[color-mix(in_oklch,var(--color-background),var(--color-foreground)_3%)] dark:bg-background pt-7',
    ...
    <div :class="[
      ...
      'before:inset-0 before:absolute before:bg-primary before:border before:border-primary dark:before:border-[color-mix(in_oklch,var(--color-background),white_27%)] dark:before:bg-[color-mix(in_oklch,var(--color-background),white_14%)] before:rounded-2xl',
      'after:inset-0 after:absolute after:bg-primary/30 after:mx-4 after:border after:border-primary/10 dark:after:border-[color-mix(in_oklch,var(--color-background),white_27%)] dark:after:bg-[color-mix(in_oklch,var(--color-background),white_14%)] after:z-[-1] after:rounded-2xl after:-mt-3',
    ]">
      <a href=""
        class="relative text-(--color-nav-foreground) hidden h-full items-center px-7 xl:flex before:inset-y-0 before:w-px before:right-0 before:bg-(--color-nav-foreground)/20 before:absolute before:my-5">
        <div class="from-theme-1 to-theme-2 flex size-8.5 items-center justify-center rounded-lg bg-linear-to-r">
          <div class="relative h-4 w-4 -rotate-45 [&_div]:bg-white">
            ...
            <div class="absolute inset-y-0 right-0 my-auto h-[75%] w-[21%] rounded-full opacity-50"></div>
          </div>
        </div>
        <div class="ml-3.5">
      ...
      <div class="relative flex h-full grow items-center gap-5 px-7">
        <div @click="openMobileMenu"
          ...
          <Lucide class="rotate-90 [--color:var(--color-nav-foreground)] size-4!" icon="ChartNoAxesColumn" />
        </div>
        <Breadcrumb
