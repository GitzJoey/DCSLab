...
class PurchaseOrderActionsReadTest extends ActionsTestCase
{
    ...
    public function test_purchase_order_actions_call_read_any_with_nonexistance_companyId_expect_empty_collection()
    {
    ...
    public function test_purchase_order_actions_call_read_any_with_search_parameter_expect_filtered_results()
    {
        $purchaseOrderCount = 4;
        $idxTest = random_int(0, $purchaseOrderCount - 1);
        $defaultName = PurchaseOrder::factory()->make()->name;
        $testname = PurchaseOrder::factory()->insertStringInName('testing')->make()->name;

        $user = User::factory()
            ->has(Company::factory()->setStatusActive()->setIsDefault()
                ->has(PurchaseOrder::factory()->count($purchaseOrderCount)
                    ->state(new Sequence(
    ...
    public function test_purchase_order_actions_call_read_any_with_page_parameter_negative_expect_results()
    {
