...
<template>
  <div
    :class="[
      'enigma min-h-screen bg-[color-mix(in_oklch,_var(--color-background),_var(--color-foreground)_3%)] dark:bg-background pt-7',
  ...
  >
    <div
      :class="[
        ...
        'before:inset-0 before:absolute before:bg-primary before:border before:border-primary dark:before:border-[color-mix(in_oklch,_var(--color-background),_white_27%)] dark:before:bg-[color-mix(in_oklch,_var(--color-background),_white_14%)] before:rounded-2xl',
        'after:inset-0 after:absolute after:bg-primary/30 after:mx-4 after:border after:border after:border-primary/10 dark:after:border-[color-mix(in_oklch,_var(--color-background),_white_27%)] dark:after:bg-[color-mix(in_oklch,_var(--color-background),_white_14%)] after:z-[-1] after:rounded-2xl after:-mt-3',
      ]"
    >
      <a
        href=""
