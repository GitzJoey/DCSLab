...
import { FormInput, FormLabel, FormInputCode, FormErrorMessages, FormTextarea, FormSelect } from "@/components/Base/Form";
    ...
    <TwoColumnsLayout :cards="cards" :using-side-tab="false" @handle-expand-card="handleExpandCard">
      ...
      <template #card-items-1>
        <div class="p-5">
          ...
          <div class="pb-4">
            ...
            <FormSelect v-model="unitForm.type" :class="{ 'border-danger': unitForm.invalid('type') }" @change="unitForm.validate('type')">
      ...
      <template #card-items-button>
        <div class="flex gap-4">
          <Button type="submit" href="#" variant="primary" class="w-28 shadow-md" :disabled="unitForm.validating || unitForm.hasErrors">
