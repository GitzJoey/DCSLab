...
class ProductTableSeeder extends Seeder
{
    ...
    public function run($productPerCompany = 5, $onlyThisCompanyId = 0, $productCategory = 3)
    {
        ...
        foreach ($companyIds as $companyId) {
            if ($productCategory == ProductCategory::PRODUCTS->value || $productCategory == ProductCategory::PRODUCTS_AND_SERVICES->value) {
            ...
            } elseif ($productCategory == ProductCategory::SERVICES->value || $productCategory == ProductCategory::PRODUCTS_AND_SERVICES->value) {
                for ($i = 0; $i < $productPerCompany; $i++) {
