...
class PrepaidIncomePaymentResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            $this->mergeWhen($this->relationLoaded('prepaidIncome'), [
                'prepaid_income' => new PrepaidIncomeResource($this->whenLoaded('prepaidIncome')),
            ]),
