...
import { PurchaseOrderDownPaymentAllocationStatus } from '@/types/enums/PurchaseOrderDownPaymentAllocationStatus';

const { t } = useI18n();

const loading = ref(false);
const titleView = ref<string>('views.purchase_order_down_payment.page_title_not_fully_allocated');
...
const onModeStateChanged = (state: ViewMode) => {
  if (state === ViewMode.LIST) {
    titleView.value = 'views.purchase_order_down_payment.page_title_not_fully_allocated';
  }
};
  ...
  <div class="mt-8">
    <LoadingOverlay :visible="loading">
      ...
      <PurchaseOrderDownPaymentList
        :preset-allocation-status="PurchaseOrderDownPaymentAllocationStatus.NOT_FULLY_ALLOCATED"
