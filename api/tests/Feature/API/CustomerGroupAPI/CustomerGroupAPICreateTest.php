...
class CustomerGroupAPICreateTest extends APITestCase
{
    ...
    public function test_customer_group_api_call_store_without_authorization_expect_unauthorized_message()
    {
        ...
        $api = $this->json('POST', route('api.post.customer_group.save'), $customerGroupArr);
    ...
    public function test_customer_group_api_call_store_with_nonexistance_branch_id_expect_failed()
    {
        $this->markTestIncomplete('Not implemented yet.');
    }
    ...
    public function test_customer_group_api_call_store_with_existing_code_in_different_company_expect_successful()
    {
        $user = User::factory()
            ->hasAttached(Role::where('name', '=', UserRolesEnum::DEVELOPER->value)->first())
            ->has(Company::factory()->setStatusActive()->setIsDefault())
