...
class PurchaseReturnAdditionalCostStoreValidCode implements ValidationRule
{
    protected $companyId;
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        if ($value !== config('dcslab.KEYWORDS.AUTO')) {
            ...
            if (! $purchaseReturnAdditionalCostActions->isUniqueCode($this->companyId, $value, null)) {
