    ...
    Route::group(['prefix' => 'dashboard', 'as' => '.db'], function () {
        ...
        Route::group(['prefix' => 'company', 'as' => '.company'], function () {
            ...
            Route::group(['prefix' => 'branch', 'as' => '.branch'], function () {
                ...
                Route::get('read/by/company/{company:ulid}', [BranchController::class, 'getBranchByCompany'])->name('.read.by.company');
                Route::get('read/mainbranch/by/company/{company:ulid}', [BranchController::class, 'getMainBranchByCompany'])->name('.read.mainbranch.by.company');
            });
