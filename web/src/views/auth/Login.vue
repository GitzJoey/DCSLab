          ...
          <div class="block grid-cols-2 gap-4 xl:grid">
            <div class="hidden min-h-screen flex-col xl:flex">
              ...
              <div class="my-auto">
                ...
                <div class="mt-10 text-4xl font-medium leading-tight text-white"></div>
                <div class="mt-5 text-lg text-white opacity-60"></div>
              </div>
            </div>
            <div class="my-10 flex h-screen py-5 xl:my-0 xl:h-auto xl:py-0">
              ...
              >
                ...
                <div class="mt-2 text-center opacity-70 xl:hidden">&nbsp;</div>
                <form id="LoginForm" @submit.prevent="onSubmit">
                  ...
                  <div class="mt-10 text-center opacity-70 xl:mt-24 xl:text-left"></div>
                </form>
              </Box>
            </div>
          </div>
