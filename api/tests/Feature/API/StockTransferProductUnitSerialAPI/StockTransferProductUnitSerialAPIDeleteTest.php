...
class StockTransferProductUnitSerialAPIDeleteTest extends APITestCase
{
    ...
    public function test_stock_transfer_product_unit_serial_api_call_delete_without_authorization_expect_unauthorized_message()
    {
        $user = User::factory()
    ...
    public function test_stock_transfer_product_unit_serial_api_call_delete_without_access_right_expect_unauthorized_message()
    {
        $user = User::factory()
            ->has(Company::factory()->setStatusActive()->setIsDefault())
            ->create();
    ...
    public function test_stock_transfer_product_unit_serial_api_call_delete_expect_successful()
    {
        $user = User::factory()
            ->hasAttached(Role::where('name', '=', UserRolesEnum::DEVELOPER->value)->first())
            ->has(Company::factory()->setStatusActive()->setIsDefault())
    ...
    public function test_stock_transfer_product_unit_serial_api_call_delete_of_nonexistance_ulid_expect_not_found()
    {
    ...
    public function test_stock_transfer_product_unit_serial_api_call_delete_without_parameters_expect_failed()
    {
