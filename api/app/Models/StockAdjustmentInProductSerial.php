...
class StockAdjustmentInProductSerial extends Model
{
    use BootableModel;
    use HasFactory;
    ...
    public function stockAdjustmentInProduct()
    {
        return $this->belongsTo(StockAdjustmentInProduct::class)->withTrashed();
    }
