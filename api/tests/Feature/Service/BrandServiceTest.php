...
class BrandServiceTest extends ServiceTestCase
{
    ...
    /* #region others */
    public function test_brand_service_call_function_generateUniqueCode_expect_unique_code_returned()
    {
        $this->assertIsString($this->brandService->generateUniqueCode());
    }

    public function test_brand_service_call_function_isUniqueCode_expect_can_detect_unique_code()
    {
        $user = User::factory()
