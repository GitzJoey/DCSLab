...
import { FormInput, FormLabel, FormTextarea, FormSelect, FormSwitch, FormFileUpload, FormErrorMessages } from "@/components/Base/Form";
    ...
    <TwoColumnsLayout :cards="cards" :using-side-tab="false" @handle-expand-card="handleExpandCard">
      ...
      <template #card-items-1>
        <div class="p-5">
          <div class="pb-4">
            ...
            <FormInput v-model="userForm.first_name" type="text" :class="{ 'border-danger': false }" :placeholder="t('views.user.fields.name')" />
          </div>
          <div class="pb-4">
          ...
          <div class="pb-4">
            ...
            <FormInput v-model="userForm.city" type="text" class="form-control" :placeholder="t('views.user.fields.city')" />
          </div>
          <div class="pb-4">
          ...
          <div class="pb-4">
            ...
            <FormFileUpload v-model="userForm.img_path" :class="{ 'border-danger': false }" :placeholder="t('views.user.fields.picture')" />
          </div>
          <div class="pb-4">
            <FormLabel :class="{ 'text-danger': userForm.invalid('tax_id') }">
              {{ t("views.user.fields.tax_id") }}
            </FormLabel>
            <FormInput v-model="userForm.tax_id" type="text" :class="{ 'border-danger': userForm.invalid('tax_id') }" @change="userForm.validate('tax_id')" />
          ...
          <div class="pb-4">
            ...
            <FormInput v-model="userForm.ic_num" type="text" :class="{ 'border-danger': userForm.invalid('ic_num') }" @change="userForm.validate('ic_num')" />
          ...
          <div class="pb-4">
            ...
            <FormSelect v-model="userForm.status" :class="{ 'border-danger': userForm.invalid('status') }" @change="userForm.validate('status')">
              <option value="">
                {{ t("components.dropdown.placeholder") }}
              </option>
          ...
          <div class="pb-4">
            ...
            <FormTextarea v-model="userForm.remarks" type="text" :placeholder="t('views.user.fields.remarks')" rows="3" />
          </div>
        </div>
      </template>
      <template #card-items-2>
        <div class="p-5">
          <div class="pb-4">
            ...
            <FormSelect v-model="userForm.roles" multiple size="6" :class="{ 'border-danger': userForm.invalid('roles') }" @change="userForm.validate('roles')">
      ...
      <template #card-items-button>
        <div class="flex gap-4">
          <Button type="submit" href="#" variant="primary" class="w-28 shadow-md" :disabled="userForm.validating || userForm.hasErrors">
