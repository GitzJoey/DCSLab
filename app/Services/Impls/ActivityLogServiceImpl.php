    ...
    public function RoutingActivity($routeName, $routeParameters)
    {
        switch ($routeName) {
            ...
            case 'db.finance.cashes':
                $friendlyName = 'Cashes';
                break;    
            case 'db.finance.investors':
                $friendlyName = 'Investors';
                break;    
            case 'db.finance.capitals':
                $friendlyName = 'Capitals';
                break;    
            case 'db.finance.capital_groups':
                $friendlyName = 'Capital Groups';
                break;    
            ...
            case 'db.products':
                ...
                break;
            case 'db.sales.customer_groups':
                $friendlyName = 'Customer Groups';
                break;
            case 'db.sales.customers':
