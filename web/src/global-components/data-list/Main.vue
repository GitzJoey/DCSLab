        ...
        <div class="grid grid-cols-12 gap-6 mt-5" v-if="!loading">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                ...
                <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0 mr-3" v-if="enableSearch">
                    <div class="w-56 relative text-gray-700 dark:text-slate-300">
                ...
                <button class="btn btn-primary-soft shadow-md mr-2 w-20" @click="$emit('dataListChange', { page: data.meta.current_page, pageSize: pageSize, search: search, refresh: false })"><RefreshCwIcon class="w-4 h-4" /></button>
            </div>
