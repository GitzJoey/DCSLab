...
class PurchaseReceiptProductUnitSerialStoreValidCode implements ValidationRule
{
    protected $companyId;
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        if ($value !== config('dcslab.KEYWORDS.AUTO')) {
            ...
            if (! $purchaseReceiptProductUnitSerialActions->isUniqueCode($this->companyId, $value, null)) {
