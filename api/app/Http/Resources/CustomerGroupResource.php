...
class CustomerGroupResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'selling_point_multiple' => dec_trim($this->selling_point_multiple),
            'sell_at_cost' => $this->sell_at_cost,
            'price_markup_percent' => dec_trim($this->price_markup_percent),
            'price_markup_nominal' => dec_trim($this->price_markup_nominal),
            'price_markdown_percent' => dec_trim($this->price_markdown_percent),
            'price_markdown_nominal' => dec_trim($this->price_markdown_nominal),
