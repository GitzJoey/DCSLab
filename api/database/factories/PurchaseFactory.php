...
class PurchaseFactory extends Factory
{
    public function definition(): array
    {
        return [
            ...
            'date' => fake()->date(),
            'due_days' => fake()->numberBetween(1, 30),
            'delivery_note_reference' => fake()->sentence(),
            'purchase_tax_invoice_number' => fake()->sentence(),
            'purchase_tax_invoice_vat_base' => fake()->randomNumber(0, 1000000),
            'purchase_tax_invoice_vat' => fake()->randomNumber(0, 1000000),
            ...
            'purchase_total' => fake()->randomNumber(0, 1000000),
            'purchase_global_discount_rate' => fake()->randomNumber(0, 1000000),
            'purchase_global_discount_fixed' => fake()->randomNumber(0, 1000000),
            'purchase_additional_cost' => fake()->randomNumber(0, 1000000),
            'purchase_rounding' => fake()->randomNumber(0, 1000000),
            'purchase_grand_total' => fake()->randomNumber(0, 1000000),
            ...
            'amount_paid_by_purchase_order_down_payment' => fake()->randomNumber(0, 1000000),
            'amount_paid_by_purchase_return' => fake()->randomNumber(0, 1000000),
