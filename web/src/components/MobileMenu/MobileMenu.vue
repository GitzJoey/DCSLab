  ...
  <div :class="[
    ...
    <div class="h-[70px] px-3 sm:px-8 flex items-center">
      ...
      <a href="#" @click="(e) => e.preventDefault()">
        <Lucide icon="BarChart2" class="w-8 h-8 text-white transform -rotate-90"
          @click="() => { setActiveMobileMenu(!activeMobileMenu); }" />
      </a>
    </div>
    <div ref="scrollableRef" :class="twMerge([
      ...
      <a href="#" @click="(e) => e.preventDefault()" :class="[
        ...
        <template v-for="(menu, menuKey) in formattedMenu">
          ...
          <li v-else>
            <a :href="menu.subMenu
              ...
              @click="(event) => { event.preventDefault(); linkTo(menu, router, setActiveMobileMenu); setFormattedMenu([...formattedMenu]); }"
              ...
              <ul v-if="menu.subMenu && menu.activeDropdown" :class="{ 'menu__sub-open': menu.activeDropdown }">
                <li v-for="(subMenu, subMenuKey) in menu.subMenu" :key="subMenuKey">
                  <a :href="subMenu.subMenu
                    ...
                    @click="(event) => { event.preventDefault(); linkTo(subMenu, router, setActiveMobileMenu); setFormattedMenu([...formattedMenu]); }"
                    ...
                    <ul v-if="subMenu.subMenu && subMenu.activeDropdown"
                      ...
                      <li v-for="(lastSubMenu, lastSubMenuKey) in subMenu.subMenu" :key="lastSubMenuKey">
                        <a :href="lastSubMenu.subMenu
                          ...
                          @click="(event) => { event.preventDefault(); linkTo(lastSubMenu, router, setActiveMobileMenu); setFormattedMenu([...formattedMenu]); }"
                          :class="[
