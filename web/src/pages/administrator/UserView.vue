        ...
        <VeeForm id="userForm" v-slot="{ errors }" @submit="onSubmit">
          ...
          <TwoColumnsLayout :cards="cards" :using-side-tab="false" @handle-expand-card="handleExpandCard">
            <template #card-items-0>
              <div class="p-5">
                <div class="pb-4">
                  ...
                  <VeeField name="name" v-slot="{ field }" v-model="userForm.data.name" rules="required|alpha_num"
                    :label="t('views.user.fields.name')">
                    <FormInput name="name" id="name" v-bind="field" type="text"
                ...
                <div class="pb-4">
                  ...
                  <VeeField name="email" v-slot="{ field }" v-model="userForm.data.email" rules="required|email" :label="t('views.user.fields.email')">
                    <FormInput name="email" id="email" v-bind="field" type="text"
            ...
            <template #card-items-1>
              <div class="p-5">
                <div class="pb-4">
                  <VeeField name="first_name" v-model="userForm.data.profile.first_name" v-slot="{ field }">
                    <FormLabel html-for="first_name">{{ t('views.user.fields.first_name') }}</FormLabel>
                    <FormInput name="first_name" id="first_name" v-bind="field" type="text"
                      :class="{ 'border-danger': errors['first_name'] }" :placeholder="t('views.user.fields.name')" />
                  </VeeField>
                </div>
                <div class="pb-4">
                  <VeeField name="last_name" v-model="userForm.data.profile.last_name" v-slot="{ field }">
                    <FormLabel html-for="last_name">{{ t('views.user.fields.last_name') }}</FormLabel>
                    <FormInput name="last_name" id="last_name" v-bind="field" type="text"
                      :placeholder="t('views.user.fields.last_name')" />                  
                  </VeeField>
                </div>
                <div class="pb-4">
                  <VeeField name="address" v-model="userForm.data.profile.address" v-slot="{ field }">
                    <FormLabel html-for="address" class="form-label">{{ t('views.user.fields.address') }}</FormLabel>
                    <FormInput name="address" id="address" v-bind="field" type="text"
                      :placeholder="t('views.user.fields.address')" />
                  </VeeField>
                </div>
                <div class="pb-4">
                  <VeeField name="city" v-model="userForm.data.profile.city" v-slot="{ field }">
                    <FormLabel html-for="city">{{ t('views.user.fields.city') }}</FormLabel>
                    <FormInput name="city" id="city" v-bind="field" type="text" class="form-control"
                      :placeholder="t('views.user.fields.city')" />
                  </VeeField>
                </div>
                <div class="pb-4">
                  <VeeField name="postal_code" v-model="userForm.data.profile.postal_code" v-slot="{ field }">
                    <FormLabel html-for="postal_code">{{ t('views.user.fields.postal_code') }}</FormLabel>
                    <FormInput name="postal_code" id="postal_code" v-bind="field" type="text"
                ...
                <div class="pb-4">
                  ...
                  <VeeField name="country" v-slot="{ field }" v-model="userForm.data.profile.country" rules="required" :label="t('views.user.fields.country')">
                    <FormSelect name="country" id="country" v-bind="field"
                ...
                <div class="pb-4">
                  ...
                  <FormFileUpload name="img_path" id="img_path" v-model="userForm.data.profile.img_path" type="text"
                ...
                <div class="pb-4">
                  ...
                  <VeeField name="tax_id" v-slot="{ field }" v-model="userForm.data.profile.tax_id" rules="required" :placeholder="t('views.user.fields.tax_id')" 
                    :label="t('views.user.fields.tax_id')">
                    <FormInput name="tax_id" id="tax_id" v-bind="field" type="text"
                ...
                <div class="pb-4">
                  ...
                  <VeeField name="ic_num" v-slot="{ field }" v-model="userForm.data.profile.ic_num" rules="required" :placeholder="t('views.user.fields.ic_num')" 
                ...
                <div class="pb-4">
                  ...
                  <VeeField name="status" v-slot="{ field }" v-model="userForm.data.profile.status" rules="required" :label="t('views.user.fields.status')">
                    <FormSelect name="status" id="status" v-bind="field"
                ...
                <div class="pb-4">
                  <VeeField name="remarks" v-model="userForm.data.profile.remarks" v-slot="{ field }">
                    <FormLabel html-for="remarks" :class="{ 'text-danger': errors['remarks'] }">
                      {{ t('views.user.fields.remarks') }}
                    </FormLabel>
                    <FormTextarea name="remarks" id="remarks" v-bind="field" type="text" 
            ...
            <template #card-items-2>
              <div class="p-5">
                <div class="pb-4">
                  ...
                  <VeeField name="roles" v-slot="{ field }" v-model="userForm.data.roles" rules="required" :label="t('views.user.fields.roles')">
            ...
            <template #card-items-3>
              <div class="p-5">
                <div class="pb-4">
                  ...
                  <VeeField name="theme" v-model="userForm.data.settings.theme" v-slot="{ field }">
                    <FormSelect name="theme" v-show="mode == ViewMode.FORM_CREATE || mode == ViewMode.FORM_EDIT" id="theme"
                      v-bind="field">
                ...
                <div class="pb-4">                  
                  ...
                  <VeeField name="date_format" v-model="userForm.data.settings.date_format" v-slot="{ field }">
                    <FormSelect name="date_format" v-show="mode == ViewMode.FORM_CREATE || mode == ViewMode.FORM_EDIT" id="date_format"
                      v-bind="field">
                ...
                <div class="pb-4">                                  
                  ...
                  <VeeField name="time_format" v-model="userForm.data.settings.time_format" v-slot="{ field }">
                    <FormSelect name="time_format" v-show="mode == ViewMode.FORM_CREATE || mode == ViewMode.FORM_EDIT" id="time_format"
                      v-bind="field">
