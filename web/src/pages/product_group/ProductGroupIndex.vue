...
const titleView = ref<string>('views.product_group.page_title');
// #endregion
...
const createNew = () => {
    ...
    router.push({ name: 'side-menu-product-product_group-create' });
}
...
const onModeStateChanged = (state: ViewMode) => {
    ...
    switch (state) {
        case ViewMode.FORM_CREATE:
            titleView.value = 'views.product_group.actions.create';
            break;
        case ViewMode.FORM_EDIT:
            titleView.value = 'views.product_group.actions.edit';
            break;
        case ViewMode.INDEX:
        case ViewMode.LIST:
        default:
            titleView.value = 'views.product_group.page_title';
            break;
    }
}
...
const clearCache = (mode: ViewMode) => {
    switch (mode) {
        case ViewMode.FORM_CREATE:
            cacheService.removeLastEntity('PRODUCT_GROUP_CREATE');
            break;
        case ViewMode.FORM_EDIT:
            cacheService.removeLastEntity('PRODUCT_GROUP_EDIT');
            break;
        default:
            break;
    }
