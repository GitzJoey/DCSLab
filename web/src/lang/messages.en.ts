...
import asset_category from './en/views/asset_category.json';
import asset_unit from './en/views/asset_unit.json';
import asset from './en/views/asset.json';
import asset_adjustment from './en/views/asset_adjustment.json';
import asset_adjustment_in_item from './en/views/asset_adjustment_in_item.json';
import asset_adjustment_out_item from './en/views/asset_adjustment_out_item.json';
import asset_purchase from './en/views/asset_purchase.json';
import asset_purchase_item from './en/views/asset_purchase_item.json';
import asset_sale from './en/views/asset_sale.json';
import asset_sale_item from './en/views/asset_sale_item.json';
...
import chart_of_account from './en/views/chart_of_account.json';
import journal_entry from './en/views/journal_entry.json';
import balance_sheet from './en/views/balance_sheet.json';
