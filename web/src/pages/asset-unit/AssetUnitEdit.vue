...
const assetUnitForm = assetUnitService.useAssetUnitEditForm(route.params.ulid.toString());
...
const loadData = async () => {
  ...
  const result = await assetUnitService.read(route.params.ulid.toString());
      ...
      <template #card-items-button>
        <div class="flex gap-4">
          <Button
            ...
            :disabled="assetUnitForm.validating || assetUnitForm.hasErrors"
          >
