                        ...
                        <div v-for="(item, index) in outProductsForm" :key="index"
                            ...
                            <div class="grid grid-cols-12 gap-4 gap-y-3">
                                ...
                                <div class="col-span-12 lg:col-span-3">
                                    ...
                                    <FormErrorMessages
                                        :messages="(stockAdjustmentForm.errors as any)[`out_products.${index}.product_unit_conversion_value`]" />
                                    <div class="text-sm text-slate-500 text-right font-bold mt-1">
                                        {{ item.product_unit_base_unit_name }}
                                    </div>
                                </div>
                                ...
                                <div v-if="outProductsRemarksExpanded[index]" class="col-span-12">
                                    ...
                                    <FormTextarea rows="2" v-model="stockAdjustmentForm.out_products[index].remarks"
                                        :class="{ 'border-danger': stockAdjustmentForm.invalid(`out_products.${index}.remarks` as any) }"
