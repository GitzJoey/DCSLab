...
use App\Rules\EmployeeStoreValidCode;
use App\Rules\EmployeeUpdateValidCode;
    ...
    public function rules()
    {
        ...
        switch ($currentRouteMethod) {
            ...
            case 'store':
                return [
                    'company_id' => ['required', 'integer', 'bail', new IsValidCompany()],
                    'code' => ['required', 'string', 'max:255', new EmployeeStoreValidCode($this->company_id)],
                    'remarks' => ['nullable', 'string', 'max:255'],
                ];
            case 'update':
                return [
                    'company_id' => ['required', 'integer', 'bail', new IsValidCompany()],
                    'code' => ['required', 'string', 'max:255', new EmployeeUpdateValidCode($this->company_id, $this->route('employee'))],
                    'remarks' => ['nullable', 'string', 'max:255'],
                ];
            case 'delete':
                return [
