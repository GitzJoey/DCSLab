...
const titleView = ref<string>('views.employee.page_title');
// #endregion
...
const createNew = () => {
    ...
    router.push({ name: 'side-menu-company-employee-create' });
}
...
const backToList = async () => {
    ...
    router.push({ name: 'side-menu-company-employee-list' });
}
...
const onModeStateChanged = (state: ViewMode) => {
    ...
    switch (state) {
        case ViewMode.FORM_CREATE:
            titleView.value = 'views.employee.actions.create';
            break;
        case ViewMode.FORM_EDIT:
            titleView.value = 'views.employee.actions.edit';
            break;
        case ViewMode.INDEX:
        case ViewMode.LIST:
        default:
            titleView.value = 'views.employee.page_title';
            break;
    }
}
...
const clearCache = (mode: ViewMode) => {
    switch (mode) {
        case ViewMode.FORM_CREATE:
            cacheService.removeLastEntity('EMPLOYEE_CREATE');
            break;
        case ViewMode.FORM_EDIT:
            cacheService.removeLastEntity('EMPLOYEE_EDIT');
            break;
        default:
            break;
    }
