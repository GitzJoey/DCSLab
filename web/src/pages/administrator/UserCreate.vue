...
import { FormInput, FormLabel, FormTextarea, FormSelect, FormFileUpload, FormErrorMessages } from "@/components/Base/Form";
      ...
      <template #card-items-1>
        <div class="p-5">
          ...
          <div class="pb-4">
            ...
            <FormInput v-model="userForm.ic_num" type="text" :class="{ 'border-danger': false }" @change="userForm.validate('ic_num')" />
          ...
          <div class="pb-4">
            ...
            <FormSelect v-model="userForm.status" :class="{ 'border-danger': false }" @change="userForm.validate('status')">
              <option value="">
                {{ t("components.dropdown.placeholder") }}
              </option>
