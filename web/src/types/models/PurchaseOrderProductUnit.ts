...
export interface PurchaseOrderProductUnit {
    ...
    product_unit_per_unit_discount: PurchaseOrderProductUnitPerUnitDiscount[],
    product_unit_sub_total: number,
    product_unit_per_unit_sub_total_discount: PurchaseOrderProductUnitPerUnitSubTotalDiscount[],
