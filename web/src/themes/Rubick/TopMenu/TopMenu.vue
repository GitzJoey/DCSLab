...
<template>
  <div :class="[
    ...
    <div :class="[
      ...
      <a class="text-(--color-nav-foreground) border-(--color-nav-foreground)/20 hidden h-full items-center border-r px-7 xl:flex"
        href="">
      ...
      <div class="flex h-full grow items-center gap-5 px-7">
        ...
        <Breadcrumb :items="['Apps', 'Dashboards', 'Overview']"
