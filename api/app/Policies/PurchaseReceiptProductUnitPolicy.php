...
class PurchaseReceiptProductUnitPolicy
{
    ...
    public function viewAny(User $user)
    {
        ...
        if ($user->hasPermission('purchase_receipt_product_unit-readAny')) {
            return true;
        }
    }
    ...
    public function view(User $user, ?PurchaseReceiptProductUnit $purchaseReceiptProductUnit = null)
    {
        ...
        if ($user->hasPermission('purchase_receipt_product_unit-read')) {
            return true;
        }
    }
    ...
    public function create(User $user)
    {
        ...
        if ($user->hasPermission('purchase_receipt_product_unit-create')) {
            return true;
        }
    }
    ...
    public function update(User $user, ?PurchaseReceiptProductUnit $purchaseReceiptProductUnit = null)
    {
        ...
        if ($user->hasPermission('purchase_receipt_product_unit-update')) {
            return true;
        }
    }
    ...
    public function delete(User $user, ?PurchaseReceiptProductUnit $purchaseReceiptProductUnit = null)
    {
        ...
        if ($user->hasPermission('purchase_receipt_product_unit-delete')) {
            return true;
        }
    }
