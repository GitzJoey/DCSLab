...
import type {
  JournalEntryItemReadAnyGetRequest,
  JournalEntryItemReadAnyPaginateRequest,
} from '../types/services/journal-entry-item/JournalEntryItemRequest';
...
export default class JournalEntryItemService {
  ...
  public async readAnyPaginate(
    args: JournalEntryItemReadAnyPaginateRequest,
  ): Promise<ServiceResponse<Collection<Array<JournalEntryItem>> | null>> {
    const result: ServiceResponse<Collection<Array<JournalEntryItem>> | null> = {
      success: false,
    };
    ...
    try {
      ...
      const response: AxiosResponse<Collection<Array<JournalEntryItem>>> = await axios.get(url);
