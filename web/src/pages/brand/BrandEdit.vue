...
const brandForm = brandServices.useBrandEditForm(route.params.ulid as string);
// #endregion
...
const loadData = async (ulid: string) => {
    ...
    let response: ServiceResponse<Brand | null> = await brandServices.read(ulid);
