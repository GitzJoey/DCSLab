  ...
  <div :class="[
    ...
    <div @mouseenter="onMouseEnterSideMenu" @mouseleave="onMouseLeaveSideMenu" :class="[
      ...
      <div :class="[
        ...
        <div
          class="relative z-10 hidden h-16.25 w-68.75 flex-none items-center overflow-hidden px-5 duration-100 xl:flex group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-68.75 group-[.side-menu--collapsed]:xl:w-27.5">
          <a class="flex items-center transition-[margin] duration-100 xl:ml-3 group-[.side-menu--collapsed.side-menu--on-hover]:xl:ml-3 group-[.side-menu--collapsed]:xl:ml-7"
            href="">
        ...
        <AccountTrigger
          ...
          <AccountDropdown class="absolute bottom-0 left-full origin-bottom-left"
    ...
    <div :class="[
      ...
      'after:absolute after:inset-y-4 after:-ml-px after:right-4 after:left-4 xl:after:left-7 after:bg-[color-mix(in_oklch,var(--color-background),var(--color-foreground)_2%)] after:rounded-4xl after:border after:border-foreground/15 dark:after:bg-[color-mix(in_oklch,var(--color-background),var(--color-foreground)_10%)]',
      'xl:ml-68.75',
          ...
          <div @scroll="onScrollContent" :class="[
            ...
            <div :class="['top-bar group sticky inset-x-0 top-0 z-999', { scrolled: scrolled }]">
              <Box raised="single" class="flex h-16 items-center gap-5">
                ...
                <Breadcrumb class="mr-auto hidden xl:flex" :items="['Apps', 'Dashboards', 'Overview']" />
                <div
