<script setup lang="ts">
  ...
  const cards = ref<Array<TwoColumnsLayoutCards>>([
    ...
    {
      title: 'views.branch.field_groups.branch_data',
      state: CardState.Expanded,
    },
  ...
  const loadFromCache = () => {
    let data = cacheServices.getLastEntity('BRANCH_CREATE') as Record<
      string,
      unknown
    >;
    if (!data) return;
      ...
      <template #card-items-1>
        <div class="p-5">
          ...
          <div class="pb-4">
            ...
            <FormTextarea
              v-model="branchForm.remarks"
              type="text"
              :placeholder="t('views.branch.fields.remarks')"
              rows="3"
            />
          </div>
          <div class="pb-4">
