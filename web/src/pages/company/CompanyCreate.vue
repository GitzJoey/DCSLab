...
const cards = ref<Array<TwoColumnsLayoutCards>>([
  {
    title: "views.company.field_groups.company_data",
    ...
    <TwoColumnsLayout :cards="cards" :using-side-tab="false" @handle-expand-card="handleExpandCard">
        ...
        <div class="p-5">
          <div class="pb-4">
            ...
            <FormInputCode
              ...
              @set-auto="setCode"
              @change="companyForm.validate('code')"
            />
          ...
          <div class="pb-4">
            ...
            <FormInput
              ...
              :placeholder="t('views.company.fields.name')"
          ...
          <div class="pb-4">
            ...
            <FormSelect v-model="companyForm.status" :class="{ 'border-danger': companyForm.invalid('status') }" @change="companyForm.validate('status')">
              <option value="">
      ...
      <template #card-items-button>
        <div class="flex gap-4">
          <Button type="submit" href="#" variant="primary" class="w-28 shadow-md" :disabled="companyForm.validating || companyForm.hasErrors">
