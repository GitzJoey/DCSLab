...
class SaleOrderProductUnitPolicy
{
    ...
    public function viewAny(User $user)
    {
        ...
        if ($user->hasPermission('sale_order_product_unit-readAny')) {
            return true;
        }
    }
    ...
    public function view(User $user, ?SaleOrderProductUnit $saleOrderProductUnit = null)
    {
        ...
        if ($user->hasPermission('sale_order_product_unit-read')) {
            return true;
        }
    }
    ...
    public function create(User $user)
    {
        ...
        if ($user->hasPermission('sale_order_product_unit-create')) {
            return true;
        }
    }
    ...
    public function update(User $user, ?SaleOrderProductUnit $saleOrderProductUnit = null)
    {
        ...
        if ($user->hasPermission('sale_order_product_unit-update')) {
            return true;
        }
    }
    ...
    public function delete(User $user, ?SaleOrderProductUnit $saleOrderProductUnit = null)
    {
        ...
        if ($user->hasPermission('sale_order_product_unit-delete')) {
            return true;
        }
    }
