<li class="{{ active_class(if_route_pattern('db.company.*'), 'open') }}">
    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="icon icon-cup"></i><span class="sidebar-mini-hidden">{{ __('sidebar-ext.db.company')}}</span></a>
    <ul>
        <li>
...
<li class="{{ active_class(if_route_pattern('db.finance*'), 'open') }}">
    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="icon icon-cup"></i><span class="sidebar-mini-hidden">{{ __('sidebar-ext.db.finance')}}</span></a>
    <ul>
        <li>
...
<li class="{{ active_class(if_route_pattern('db.sales*'), 'open') }}">
    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="icon icon-cup"></i><span class="sidebar-mini-hidden">{{ __('sidebar-ext.db.sales')}}</span></a>
    <ul>
        <li>
