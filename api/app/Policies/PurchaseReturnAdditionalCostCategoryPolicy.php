...
class PurchaseReturnAdditionalCostCategoryPolicy
{
    ...
    public function viewAny(User $user)
    {
        ...
        if ($user->hasPermission('purchase_return_additional_cost_category-readAny')) {
            return true;
        }
    }
    ...
    public function view(User $user, ?PurchaseReturnAdditionalCostCategory $purchaseReturnAdditionalCostCategory = null)
    {
        ...
        if ($user->hasPermission('purchase_return_additional_cost_category-read')) {
            return true;
        }
    }
    ...
    public function create(User $user)
    {
        ...
        if ($user->hasPermission('purchase_return_additional_cost_category-create')) {
            return true;
        }
    }
    ...
    public function update(User $user, ?PurchaseReturnAdditionalCostCategory $purchaseReturnAdditionalCostCategory = null)
    {
        ...
        if ($user->hasPermission('purchase_return_additional_cost_category-update')) {
            return true;
        }
    }
    ...
    public function delete(User $user, ?PurchaseReturnAdditionalCostCategory $purchaseReturnAdditionalCostCategory = null)
    {
        ...
        if ($user->hasPermission('purchase_return_additional_cost_category-delete')) {
            return true;
        }
    }
