    ...
    public function toArray($request)
    {
        return [
            ...
            $this->mergeWhen($this->relationLoaded('purchaseOrderProductUnits'), [
                'product_unit' => new ProductUnitResource($this->purchaseOrderProductUnits),
            ]),
            ...
            $this->mergeWhen($this->relationLoaded('productUnitPerUnitDiscounts'), [
                'product_unit_per_unit_discount' => PurchaseOrderDiscountResource::collection($this->productUnitPerUnitDiscounts),
            ]),
            'product_unit_sub_total' => $this->product_unit_sub_total,
            $this->mergeWhen($this->relationLoaded('productUnitPerUnitSubTotalDiscounts'), [
                'product_unit_per_unit_sub_total_discount' => PurchaseOrderDiscountResource::collection($this->productUnitPerUnitSubTotalDiscounts),
            ]),
