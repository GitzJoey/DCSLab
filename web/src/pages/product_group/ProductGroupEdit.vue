...
const productGroupForm = productGroupServices.useProductGroupEditForm(route.params.ulid as string);
// #endregion
...
const loadData = async (ulid: string) => {
    ...
    let response: ServiceResponse<ProductGroup | null> = await productGroupServices.read(ulid);
...
watch(
    ...
    debounce((newValue): void => {
        cacheServices.setLastEntity('PRODUCT_GROUP_EDIT', newValue.data())
    }, 500),
    { deep: true }
);
// #endregion
