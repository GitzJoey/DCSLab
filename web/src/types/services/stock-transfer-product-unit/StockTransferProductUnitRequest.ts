export interface StockTransferProductUnitReadAnyPaginateRequest {
...
export interface StockTransferProductUnitReadAnyGetRequest {
  with_trashed: boolean;
  company_id: string;
  branch_id: string | null;
  search: string | null;
...
export interface StockTransferProductUnitStoreRequest {
  company_id: string;
  branch_id: string;
...
export interface StockTransferProductUnitUpdateRequest {
  company_id: string;
  branch_id: string;
  stock_transfer_id: string;
  qty: number;
