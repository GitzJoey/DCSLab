...
export default class ProductGroupService {
    ...
    public useProductGroupCreateForm() {
        const url = route('api.post.db.product.product_group.save', undefined, true, this.ziggyRoute);
    ...
    public async readAny(args: ReadAnyRequest): Promise<ServiceResponse<Collection<Array<ProductGroup>> | Resource<Array<ProductGroup>> | null>> {
        const result: ServiceResponse<Collection<Array<ProductGroup>> | Resource<Array<ProductGroup>> | null> = {
            success: false
        }
        ...
        try {
            ...
            const response: AxiosResponse<Collection<Array<ProductGroup>>> = await axios.get(url);
    ...
    public useProductGroupEditForm(ulid: string) {
        const url = route('api.post.db.product.product_group.edit', ulid, true, this.ziggyRoute);
