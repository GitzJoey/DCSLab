...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('liabilities', function (Blueprint $table) {
            ...
            $table->string('code');
            $table->dateTime('date');
            $table->foreignId('category_id')->references('id')->on('liability_categories');
            $table->foreignId('creditor_id')->nullable()->references('id')->on('liability_creditors');
            ...
            $table->decimal('amount_received', 30, 8)->default(0);
