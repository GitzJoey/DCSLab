...
return [
    ...
    'valid_product_group' => 'Kelompok product tidak valid',
    'valid_brand' => 'Merk tidak valid',
    'valid_unit' => 'Satuan tidak valid',
    'valid_product' => 'Product tidak valid',
    'valid_product_unit' => 'Satuan pada product tidak valid',
    'valid_supplier' => 'Supplier tidak valid',
    'purchase_order' => [
