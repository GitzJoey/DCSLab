...
return new class extends Migration
{
    ...
    {
        Schema::create('purchase_receipt_product_units', function (Blueprint $table) {
            $table->id();
            $table->ulid();
            ...
            $table->boolean('is_has_purchase')->default(false);
    ...
    {
        Schema::dropIfExists('purchase_receipt_product_units');
    }
};
