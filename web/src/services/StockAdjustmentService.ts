...
export default class StockAdjustmentService {
  ...
  public async readAnyPaginate(args: StockAdjustmentReadAnyPaginateRequest): Promise<ServiceResponse<Collection<Array<StockAdjustment>> | null>> {
  ...
  public async readAnyGet(args: StockAdjustmentReadAnyGetRequest): Promise<ServiceResponse<Resource<Array<StockAdjustment>> | null>> {
