...
return new class extends Migration
{
    ...
    {
        Schema::create('purchase_return_product_units', function (Blueprint $table) {
            $table->id();
            $table->ulid();
            ...
            $table->boolean('product_price_includes_vat')->default(false);
            $table->decimal('product_vat_base', 30, 8)->default(0);
            $table->decimal('product_vat', 30, 8)->default(0);
            $table->decimal('product_base_unit_final_price', 30, 8)->default(0);
    ...
    {
        Schema::dropIfExists('purchase_return_product_units');
    }
};
