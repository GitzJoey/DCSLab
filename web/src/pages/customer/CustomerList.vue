...
// #region Methods
const getCustomers = async (search: string, refresh: boolean, page: number, per_page: number) => {
...
const onDataListChanged = async (data: DataListEmittedData) => {
  await getCustomers(data.search.text, false, data.pagination.page, data.pagination.per_page);
};
